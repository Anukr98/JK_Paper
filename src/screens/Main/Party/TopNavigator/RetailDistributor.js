...
import { RetailDistributorCard } from '../components/RetailDistributorCard'
...
export const RetailDistributor = () => {
    ...
    if (filteredItems.length === 0 && !data.loading) {
      return (
        <View>
         <RetailDistributorCard></RetailDistributorCard>
        </View>
      );
    }
    ...
    return (
      <FlatList
        ...
        renderItem={({item, index}) => {
          return <RetailDistributorCard item={item} key={index} />;
        }}
